...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Akv:Akv@cluster0.paghy.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rajappan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

#maximum search result buttos count in number#
MAX_RIST_BTNS = int(environ.get('MAX_RIST_BTNS',"10"))
START_MESSAGE = environ.get('START_MESSAGE', '👋 𝙷𝙴𝙻𝙾 {user}\n\n𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 {bot},\n𝙸 𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 𝙼𝙾𝚅𝙸𝙴𝚂, 𝙹𝚄𝚂𝚃 𝙹𝙾𝙸𝙽 𝙸𝙽𝚃𝙾 𝙼𝚈 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙴𝙽𝙹𝙾𝚈 𝙼𝚈 𝙿𝙴𝚅𝙴𝚁 𝚂𝙷𝙾𝚆.!!𖠌✩...')
...
നിങ്ങൾക്ക് ഈ ബോട്ടിൽ നിന്നും സിനിമയുടെ ഫയലുകൾ കിട്ടണമെങ്കിൽ താഴെയുള്ള👇 ബട്ടണിൽ ക്ലിക്ക് ചെയ്ത് ആ ചാനലിൽ ജോയിൻ ചെയ്യുക, എന്നിട്ട് തിരിച്ചു ബോട്ടിൽ വന്നിട്ട് 👉 Try Again👈 ക്ലിക്ക് ചെയ്യുക')
